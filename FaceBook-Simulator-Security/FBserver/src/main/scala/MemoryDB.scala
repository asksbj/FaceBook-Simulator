...
object Server {
    ...
    var nounces = HashMap.empty[Int, Array[Byte]]
    var modulus : BigInt = _
    var RSApublickey : BigInt= 0x10001
    var RSAprivatekey : BigInt = _
    var userpublickey = HashMap.empty[Int,BigInt]

}

//case class users(id:String,username:String,email:String)
...
class Posts{
  ...
  var encodekeys = HashMap.empty[Int, BigInt]
  var create_time: Long = 20151111
}
